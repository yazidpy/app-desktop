 ...
 * @author yazid
 */
public class examen_page extends javax.swing.JFrame {
    ...
    /**
     * Creates new form examen_page
     */
    public examen_page() {
        initComponents();
        statistique();
        selectionner_emd();
        id_forma.setVisible(false);
    }

    public void statistique() {
        try {
            con = c1.connection_db();
            String query1 = "SELECT COUNT(*) FROM examens where type='Code'";
            Statement stmt1 = con.createStatement();
            ResultSet rs1 = stmt1.executeQuery(query1);
            rs1.next();
            int count1 = rs1.getInt(1);
            nb_code.setText("" + count1);
            String query2 = "SELECT COUNT(*) FROM examens where type='Créneau'";
            Statement stmt2 = con.createStatement();
            ResultSet rs2 = stmt2.executeQuery(query2);
            rs2.next();
            int count2 = rs2.getInt(1);
            nb_cre.setText("" + count2);
            String query3 = "SELECT COUNT(*) FROM examens where type='Conduite'";
            Statement stmt3 = con.createStatement();
            ResultSet rs3 = stmt3.executeQuery(query3);
            rs3.next();
            int count3 = rs3.getInt(1);
            nb_con.setText("" + count3);
            String query4 = "SELECT COUNT(*) FROM examens";
    ...
    public void selectionner_emd() {
        model = (DefaultTableModel) tableau_seance.getModel();
        model.setRowCount(0);
        try {
            con = c1.connection_db();
            PreparedStatement st = con.prepareStatement("select * from examens");
            rs = st.executeQuery();
            while (rs.next()) {
                String id = rs.getString("id_emd");
                String type = rs.getString("type");
                String date = rs.getString("date");
                String horaire = rs.getString("heure");
                int formation = rs.getInt("formation_id");
                String form_nom = "";
                PreparedStatement formation_nom = con.prepareStatement("select permis from formation where id_formation=?");
                formation_nom.setInt(1, formation);
                ResultSet rs2 = formation_nom.executeQuery();
                if (rs2.next()) {
                    form_nom = rs2.getString("permis");
                }
                
                Object[] obj = {id, type, date, horaire, form_nom};
                model.addRow(obj);
            }
            ...
            tableau_seance.addMouseListener(new java.awt.event.MouseAdapter() {
                ...
                private void table1MouseReleased(MouseEvent evt) {
                    ...
                    if (c1.est_chiffre(string_selectionner) == false) {
                        ...
                        try {
                            con = c1.connection_db();
                            PreparedStatement st = con.prepareStatement("select * from examens where id_emd=?");
                            ...
                            while (rs.next()) {
                                ...
                                id_forma.setText(formation);
                                id_veh.setText(id);
                            }
                            les_candidat.removeAllItems();
                            try {
                                PreparedStatement st2 = con.prepareStatement("select c.nom,c.prenom from candidat c ,candidat_inscrie_formation f where f.candidat_id_candidat=c.id_candidat and f.formation_id=?");
                                st2.setString(1, id_forma.getText().toString());
                                ResultSet r1 = st2.executeQuery();
                                while (r1.next()) {
                                    les_candidat.addItem(r1.getString("nom") + "," + r1.getString("prenom"));
                                }
                            } catch (Exception ex) {
                                ex.printStackTrace();
    ...
    public void supprimer_seance() {
        ...
        if (id.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Aucune Examen n'est selectionné ! ", null, JOptionPane.ERROR_MESSAGE);
        } else {
            try {
                String delete1 = "delete from candidat_passe_examen where Examen_id=?";
                PreparedStatement st1 = con.prepareStatement(delete1);
                st1.setString(1, id);
                st1.executeUpdate();
                String delete = "delete from examens where id_emd=?";
                PreparedStatement st = con.prepareStatement(delete);
                st.setString(1, id);
                st.executeUpdate();
                JOptionPane.showMessageDialog(null, "Examen supprimé avec succès ", null, JOptionPane.INFORMATION_MESSAGE);
                titre_veh.setText("");
                id_veh.setText("");
                model.setRowCount(0);
                selectionner_emd();
    ...
    private void initComponents() {
        ...
        les_candidat = new rojerusan.RSComboMetro();
        jLabel1 = new javax.swing.JLabel();
        jLabel2 = new javax.swing.JLabel();
        id_forma = new javax.swing.JLabel();
        ...
        jLabel19.setText("Liste des Examen");
        ...
        tableau_seance.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Code examen", "Type de l'examen", "Date", "Heure", "Formation"
            }
        ) {
        ...
        jLabel10.setText("Ajouter un résultat ");
        ...
        rapport.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        rapport.setRows(5);
        jScrollPane2.setViewportView(rapport);

        jLabel16.setBackground(new java.awt.Color(255, 255, 255));
        jLabel16.setIcon(new javax.swing.ImageIcon("C:\\Users\\yazid\\OneDrive\\Bureau\\Auto_Ecole\\Blue-Add-Button-PNG.png")); // NOI18N
        ...
        les_candidat.setBackground(new java.awt.Color(0, 0, 0));
        les_candidat.setForeground(new java.awt.Color(0, 0, 0));
        les_candidat.setColorArrow(new java.awt.Color(0, 0, 0));
        les_candidat.setColorFondo(new java.awt.Color(102, 255, 255));
        les_candidat.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N

        jLabel1.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        jLabel1.setText("Rapport");

        jLabel2.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        jLabel2.setText("Canddiat");
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addComponent(les_candidat, javax.swing.GroupLayout.PREFERRED_SIZE, 320, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(33, 33, 33)
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(les_candidat, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2))
        ...
        jLabel11.setText("Gestion des examanes (Code,Conduite,Créneau)");
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        ...
        ajouter_examen aj = new ajouter_examen(this);
        aj.setVisible(true);
    ...
    private void jLabel16MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel16MouseClicked
        ...
        if (id_veh.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null, "Vous devez selectionner l'examen", null, JOptionPane.ERROR_MESSAGE);
        } else {
            int id_exmd = Integer.parseInt(id_veh.getText().toString());
            String candidat = les_candidat.getSelectedItem().toString();
            if (candidat.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Vous devez selectionner le candidat", null, JOptionPane.ERROR_MESSAGE);

            } else {
                String candidat_nom_pre[] = candidat.split(",");
                String nom = candidat_nom_pre[0];
                String prenom = candidat_nom_pre[1];
                try {
                    int id_cand = 0;
                    String email = "";
                    PreparedStatement st2 = con.prepareStatement("select email, id_candidat from candidat where nom=? and prenom=?");
                    st2.setString(1, nom);
                    st2.setString(2, prenom);
                    ResultSet r1 = st2.executeQuery();
                    while (r1.next()) {
                        id_cand = r1.getInt("id_candidat");
                        email = r1.getString("email");
                    }
                    if (rapport.getText().isEmpty()) {
                        JOptionPane.showMessageDialog(null, "Vous devez inserer un message ", null, JOptionPane.ERROR_MESSAGE);
                    } else {

                        String inserer2 = "insert into candidat_passe_examen (Examen_id,raport,candidat_id_candidat) values(?,?,?)";
                        PreparedStatement insert2 = con.prepareStatement(inserer2);
                        insert2.setInt(1, id_exmd);
                        insert2.setString(2, rapport.getText().toString());
                        insert2.setInt(3, id_cand);
                        insert2.executeUpdate();

                        if (acceuil.EmailSender(email, "Rapport sur un examen", "Bonjour Chèr(e) candidat(e) voici le résultat sur votre examen : \n\n" + rapport.getText().toString() + "\n\nCordialement !")) {
                            JOptionPane.showMessageDialog(null, "Rapport envoyé avec succès", null, JOptionPane.INFORMATION_MESSAGE);
                        }
                    }
                } catch (Exception ex) {
                    ex.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(examen_page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new examen_page().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel id_forma;
    ...
    private rojerusan.RSComboMetro les_candidat;
