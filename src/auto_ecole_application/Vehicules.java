...
public class Vehicules extends javax.swing.JFrame {
    ...
    public void statistique() {
        try {
            ...
            String query1 = "SELECT COUNT(*) FROM vehicule where type_vehicule='Voiture'";
            Statement stmt1 = con.createStatement();
            ResultSet rs1 = stmt1.executeQuery(query1);
            rs1.next();
            int count1 = rs1.getInt(1);
            nbr_voiture.setText("" + count1);
            String query2 = "SELECT COUNT(*) FROM vehicule where type_vehicule='Camion'";
            Statement stmt2 = con.createStatement();
            ResultSet rs2 = stmt2.executeQuery(query2);
            rs2.next();
            int count2 = rs2.getInt(1);
            nbr_camion.setText("" + count2);
            String query3 = "SELECT COUNT(*) FROM vehicule where type_vehicule!='Voiture' and Type_vehicule!='Camion'";
            ...
            tableau_voiture.addMouseListener(new java.awt.event.MouseAdapter() {
                ...
                private void table1MouseReleased(MouseEvent evt) {
                    ...
                    if (c1.est_chiffre(string_selectionner) == false) {
                        ...
                        try {
                            con = c1.connection_db();
                            PreparedStatement st = con.prepareStatement("select * from vehicule where id_vehicule=?");
    ...
    public void supprimer_vehicule() {
        ...
        if (id.isEmpty()) {
            ...
            try {
                String delete = "delete from vehicule where id_vehicule=?";
    ...
    public void afficher_sur_formulaire() {
        if (id_veh.getText().isEmpty()) {
            ...
            Ajouter_vehicule ajouter = new Ajouter_vehicule(this);
    ...
    public void rechercher_vehicule() {
        ...
        if (la_recherche.isEmpty()) {
            ...
            try {
                con = c1.connection_db();
                PreparedStatement st = con.prepareStatement("select * from vehicule where LOWER(" + type_recherche + ") LIKE ? ");
                ...
                while (rs.next()) {
                    ...
                    Date date_aj = rs.getDate("date");
                    String etat = rs.getString("etat");
                    String matricule = rs.getString("matricule");
                    String transs = rs.getString("type_transmission");
                    String type = rs.getString("type_vehicule");

                    Object[] obj = {id, marque, annee, modele, carb, etat, matricule, transs, type, date_aj};
                    model.addRow(obj);
                }
                if (trouve == 0) {
                    model.setRowCount(0);
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Gestion des Véhicules");
        ...
        type_rech.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Marque", "Année", "Etat", "Matricule", "Type" }));
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        ...
        Ajouter_vehicule ajouter_1 = new Ajouter_vehicule(this);
