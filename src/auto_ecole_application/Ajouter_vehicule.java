...
public class Ajouter_vehicule extends javax.swing.JFrame {

    Candidat c1 = new Candidat();
    Vehicules v1 = new Vehicules();
    Connection con = null;
    Statement st = null;
    ResultSet rs = null;
    String path = null;
    byte[] voiture_image = null;
    private Vehicules instance;

    /**
     * Creates new form Ajouter_voiture
     */
    public Ajouter_vehicule(Vehicules instance) {
        initComponents();
    ...
    public void inserer_vehicule() {
        ...
        if (valider_formulaire() == true) {
            ...
            try {
                ...
                String sql = "insert into vehicule (marque,année,modèle,carburant,etat,photo,matricule,type_transmission,type_vehicule) values (?,?,?,?,?,?,?,?,?)";
                ...
                instance.selectionner_vehicule();
    ...
    public void modifier_vehicule() {
        try {
            if (valider_formulaire() == true) {
                ...
                String transm = transmission.getSelectedItem().toString();
                String type = type_vehicule.getSelectedItem().toString();
                String update_vehicule = "update vehicule set marque=?,année=?,Modèle=?,carburant=?,etat=?,matricule=?,type_transmission=?,type_vehicule=? where id_vehicule=?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ajouter_vehicule.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
